// Descripcion: Menu de Evaluacion Teorica
// Autor: Cristian Efraín Oropeza Yepiz
// Correo: oropezacistian40@gmial.com
...
SubProceso opcion<-menu
	...
	Escribir ' Promedio de los Animales(Sin realizar)[6]';
	Escribir ' Roberto y el pago de Peaje............[7]';
	Escribir ' Evaluando una expresion complicada(Sin realizar)[8]';
	Escribir ' Fechas B..............................[9]';
	...
	//Escogi el "Segun" para presentar el numero ingresado de lineas como de
	//veces diciendo Hello Wordl
			Segun n Hacer
				1:
		...
		Hasta Que n=0
		 ...
		 2:
			...
			Repetir
				...
				Escribir "Ingrese Fracciones a sumar";//se ingresa primero 
				//numerador y denominador 1, luego numerador y denominador 2
			leer n1,d1,n2,d2;
			//No utilice ningun ciclo ya que se puede hacer este algortimo 
		...
		3:
			...
			Leer n;
			//Se utiliza el ciclo for para que haga n veces las operaciones 
			//requeridas para dar el resultado pedido
			suma <- 0;
		...
		4:
			...
			Leer horas;
			h<-horas;
			// Utilice la estrutura ciclica "SI" para codicionar que sino
			//cumple decir cuantas horas faltan
			Si h = 480 Entonces
		...
		5:
			...
			Leer a,b,c;
			// Estructura ciclica que verifica el tipo de sucesion de numeros 
			//ingresados
		...
		7:
			...
			repetir 
			Escribir "Ingrese solo numeros 0 para salir";
			//utilice el ciclo for desde 1 hasta 4 veces para hacer la 
			//respectivas sumas y restas y que diera el total a pagar con 
			//respecto al costo de la primera caseta
		...
		9:
			...
			Repetir
				...
				Leer n;
				//Utilice el "SI" cuando eccediera los 30 dias se dieran 
				//los dias del siguiente mes 
				a <- a+n;
				Si a > 30 Entonces
					a<- a mod 30;
					b <- b mod 12+1;
				FinSi
				Escribir Sin Saltar "su fecha resultante es: ",a, " ", b, " ", c ;
